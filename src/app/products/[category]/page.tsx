...
const CategoryPage = () => {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      params.append("category", category); // Always filter by the current page category
    ...
    <div className="bg-[#FFFAFA] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:hidden flex justify-between items-center mb-4">
          <h1 className="text-2xl font-serif text-primary capitalize">{category} Collection</h1>
          <button
        ...
        <main className="flex-1">
          <div className="hidden lg:block mb-8 text-center relative">
             <h1 className="text-4xl font-serif text-primary mb-2 capitalize">{category} Collection</h1>
             <p className="text-muted-foreground italic">Exquisite designs curated just for you</p>
          ...
          {loading ? (
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
             ...
             <div className="flex flex-col items-center justify-center py-20 text-center">
               ...
               <p className="text-gray-500">We couldn&apos;t find any {category} matching your filters.</p>
             </div>
          ) : (
            <>
